...
<script language="javascript">
 function listado()   {
     location.href="../controller/ProductoController.php?opc=Listado";
 }
 function insertar(){
	 location.href="insertarProducto.php";
 }
 function buscar(){
	 location.href="buscarProducto.php";
 }
 function reporte(){
	 location.href="../Graficos/Grafico1.php";
 }
 </script>
</head>
...
<form id="form1" name="form1" method="post" action="../controller/ProductoController.php">
  ...
  <table width="90%" border="1" cellspacing="0" cellpadding="3">
    <tbody>
      ...
      <tr>
        ...
        <td align="center">
        <a href="../controller/ProductoController.php?cod=<?php echo $fila[0];?>&opc=Cargar">
		<?php echo $fila[0];?></a>
        </td>
